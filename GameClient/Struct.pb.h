...
class Player final :
 ...
 public:
  ...
  // bool roomMaster = 3;
  void clear_roommaster();
  bool roommaster() const;
  void set_roommaster(bool value);
  private:
  bool _internal_roommaster() const;
  void _internal_set_roommaster(bool value);
  public:

  // .Protocol.GenderType type = 4;
  void clear_type();
  ::Protocol::GenderType type() const;
  void set_type(::Protocol::GenderType value);
  private:
  ::Protocol::GenderType _internal_type() const;
  void _internal_set_type(::Protocol::GenderType value);
  public:
...
// bool roomMaster = 3;
inline void Player::clear_roommaster() {
  _impl_.roommaster_ = false;
}
inline bool Player::_internal_roommaster() const {
  return _impl_.roommaster_;
}
inline bool Player::roommaster() const {
  // @@protoc_insertion_point(field_get:Protocol.Player.roomMaster)
  return _internal_roommaster();
}
inline void Player::_internal_set_roommaster(bool value) {
  
  _impl_.roommaster_ = value;
}
inline void Player::set_roommaster(bool value) {
  _internal_set_roommaster(value);
  // @@protoc_insertion_point(field_set:Protocol.Player.roomMaster)
}
...
inline ::Protocol::GenderType Player::_internal_type() const {
  return static_cast< ::Protocol::GenderType >(_impl_.type_);
}
inline ::Protocol::GenderType Player::type() const {
  // @@protoc_insertion_point(field_get:Protocol.Player.type)
  return _internal_type();
}
inline void Player::_internal_set_type(::Protocol::GenderType value) {
  
  _impl_.type_ = value;
}
inline void Player::set_type(::Protocol::GenderType value) {
...
inline float Player::_internal_exp() const {
  return _impl_.exp_;
}
inline float Player::exp() const {
  // @@protoc_insertion_point(field_get:Protocol.Player.exp)
  return _internal_exp();
}
inline void Player::_internal_set_exp(float value) {
  
  _impl_.exp_ = value;
}
inline void Player::set_exp(float value) {
