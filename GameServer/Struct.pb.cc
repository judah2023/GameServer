...
PROTOBUF_CONSTEXPR Player::Player(
  ...
  , /*decltype(_impl_.roommaster_)*/false
...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::Player, _impl_.roommaster_),
  PROTOBUF_FIELD_OFFSET(::Protocol::Player, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::Protocol::Player, _impl_.exp_),
};
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Master\030\003 \001(\010\022\"\n\004type\030\004 \001(\0162\024.Protocol.Ge"
  "nderType\022\013\n\003exp\030\005 \001(\002b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Struct_2eproto = {
    false, false, 149, descriptor_table_protodef_Struct_2eproto,
    "Struct.proto",
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _impl_.roommaster_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          CHK_(ptr);
          _internal_set_type(static_cast<::Protocol::GenderType>(val));
        } else
          goto handle_unusual;
        continue;
      // float exp = 5;
...
uint8_t* Player::_InternalSerialize(
  ...
  // bool roomMaster = 3;
  if (this->_internal_roommaster() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(3, this->_internal_roommaster(), target);
  }
...
void Player::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_roommaster() != 0) {
    _this->_internal_set_roommaster(from._internal_roommaster());
  }
...
void Player::InternalSwap(Player* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Player, _impl_.exp_)
      + sizeof(Player::_impl_.exp_)
