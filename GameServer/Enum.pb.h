...
enum GenderType : int {
  ...
  BOTH = 3,
  ETC = 4,
  GenderType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  GenderType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool GenderType_IsValid(int value);
constexpr GenderType GenderType_MIN = NONE;
constexpr GenderType GenderType_MAX = ETC;
...
template <> struct is_proto_enum< ::Protocol::GenderType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::GenderType>() {
  return ::Protocol::GenderType_descriptor();
}
